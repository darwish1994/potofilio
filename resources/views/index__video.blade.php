...
<div class="ts-page-wrapper">
    ...
    <div class="ts-content">
        ...
        <header id="ts-hero" class="ts-height--100vh ts-has-overlay text-white">
            ...
            <div class="container">
                ...
                <h1 data-animate="ts-reveal">
                    ...
                    <br>
                    <span class="wrapper">
                        <span data-ts-delay=".05s">Preus Interactive</span>
                    </span>
                </h1>

                <h4 data-animate="ts-fadeInUp" data-ts-delay=".1s">A digital agency based in London</h4>

                <div data-animate="ts-fadeInUp" data-ts-delay=".15s">
                    <a href="#" class="btn btn-outline-light btn-sm">Check Our Works</a>
                </div>

            </div>

            <div class="ts-background" data-bg-parallax="scroll" data-bg-parallax-speed="3">
                <div class="ts-video-bg ts-parallax-element" data-vide-bg="assets/video/Working-Space"
        ...
        <main id="ts-content">
            ...
            ============================================================================================================
            -->
            <section id="blockquote" class="ts-block ts-bg-black text-white">
                <div class="container">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <a href="contact__default.html" class="ts-link">Contact Us</a>
                        </div>
                        <!--end Paragraph-->
            ...
            ============================================================================================================
            -->
            <section class="ts-block ts-background-repeat text-white ts-bg-black"
                     data-bg-image="assets/img/bg__pattern--dot--white.png">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="ts-blog-thumb">
                                ...
                                <p>
                                    Quis est pretium lobortis. Vestibulum eu ex sed nibh condimentum tristique eu
                                    finibus
