                ...
                <div class="container-fluid px-4 px-sm-0">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            ================================================================================================
                            -->
                            <div class="ts-gallery ts-overflow-y--auto ts-overflow-x--hidden ts-height--100vh">
                                <a href="assets/img/img__work--07.jpg"
                                   class="card ts-gallery__item ts-gallery__item-big popup-image">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a href="assets/img/img__work--08.jpg"
                                    ...
                                    <div class="col-md-6">
                                        <a href="assets/img/img__work--05.jpg"
                                           class="card ts-gallery__item ts-half popup-image">
                                            <div class="ts-background ts-img-into-bg">
                                                <img src="assets/img/img__work--05.jpg" alt="">
                                            </div>
                                        </a>
                                        <a href="assets/img/img__work--06.jpg"
                                           class="card ts-gallery__item ts-half popup-image">
                                            <div class="ts-background ts-img-into-bg">
                                    ...
                                    <div class="col-md-6">
                                        <a href="assets/img/img__work--03.jpg"
                                           class="card ts-gallery__item popup-image">
                                            <div class="ts-background ts-img-into-bg">
                                    ...
                                    <div class="col-md-6">
                                        <a href="assets/img/img__work--04.jpg"
                                           class="card ts-gallery__item popup-image">
                                            <div class="ts-background ts-img-into-bg">
                        ...
                        <div class="col-md-6">
                            <section class="py-5">
                                <div class="ts-title mb-5">
                                    <h1>Perrier Refresh</h1>
                                    <h4>Branding</h4>
                                </div>

                                <section class="py-5">
                                    <h2>The Story</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque nec nunc
                                        vitae
                                        nibh congue pellentesque. Mauris scelerisque quam semper feugiat tincidunt.
                                        Pellentesque a ullamcorper erat, id dapibus velit. Aliquam erat volutpat. Proin
                                        at
                                        sapien leo. Nullam fermentum purus ac massa dignissim, in cursus turpis
                                        lobortis.
                                        Aliquam lacinia ante a velit viverra scelerisque. Suspendisse nec dui sed tortor
                                        mollis
                                    </p>
                                </section>
