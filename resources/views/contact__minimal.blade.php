...
<div class="ts-page-wrapper">
    ...
    <div class="ts-content">
        ...
        <header id="ts-hero" class="ts-block ts-height--75vh">
            ...
            <div class="position-absolute ts-z-index__1 w-100 ts-pointer-none">
                <div class="container">
                    <h1 class="ts-text-underline">Hello</h1>
                </div>
            </div>

            <div class="map h-100 w-100 position-absolute ts-z-index__0" id="map-contact"></div>

            <div class="ts-background">
                <!--<div class="map h-100" id="map-contact"></div>-->
            </div>
        ...
        <main id="ts-content">
            ...
            ============================================================================================================
            -->
            <section id="offices" class="ts-block ts-background-repeat">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            ...
                            <address>
                                ...
                                +1 919-571-2528
                                <br>
                                <a href="#" class="ts-underline">hello@example.com</a>
                            </address>
                        </div>
                        <!--end Office-->
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <h4 class="font-weight-bold">Sydney</h4>
                            <address>
                                2045 John Daniel Drive
                                <br>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <h4 class="font-weight-bold">Tokyo</h4>
                            <address>
                                2257 Stewart Street
                                <br>
            ...
            <section class="py-5 my-5">
                <div class="container">
                    ...
                    <div class="d-block d-sm-flex justify-content-between">
                        ...
                        <a href="#" class="ts-align__vertical py-2">
                            <div class="ts-circle__xs ts-bg-black text-white mr-3">
        ...
        ================================================================================================================
        -->
        <footer id="ts-footer" class="ts-text-black" data-bg-color="#f9f9f9">
