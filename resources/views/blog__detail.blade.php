        ...
        <header id="ts-hero" class="ts-block">
            ...
            <div class="container pt-2 pt-sm-5 pt-lg-0">
                <div class="ts-title mb-0">
                    <h1>Vivamus porta orci eu turpis vulputate ornare fusce hendrerit arcu risu</h1>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-9">
                        ...
                        <section>
                            ...
                            <article class="blog-post">
                                ...
                                <p>
                                    ...
                                    Cras ultricies augue sapien, aliquam hendrerit mi suscipit at. Suspendisse vulputate
                                    felis eget
                                    felis convallis fermentum et eu nulla. Donec sagittis sit amet erat non eleifend.
                                    Mauris at convallis
                        ...
                        <section id="about-author">
                            ...
                            <div class="post-author p-4 border">

                                <div class="ts-circle__sm float-left mr-4">
                                    <div class="ts-img-into-bg">
                                        <img src="assets/img/img__man-hat.jpg" alt="">
                                    </div>
                                </div>

                                <div class="wrapper">
                                    <header>John Doe</header>
                                    <p class="mb-0">Phasellus metus ipsum, sollicitudin lacinia turpis in, pellentesque
                                        pulvinar diam.
                        ...
                        <section id="comments" class="py-5">
                            ...
                            <ul class="comments list-unstyled">
                                <li class="comment">
                                    <div class="ts-circle__sm float-left mr-4">
                                        <div class="ts-img-into-bg">
                                            <img src="assets/img/img__person--01.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="comment-wrapper">
                                        <div class="name pull-left">Catherine Brown</div>
                                        <span class="date"><span class="fa fa-calendar mr-2"></span>12.05.2014</span>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla vestibulum,
                                            sem ut sollicitudin consectetur,
                                            augue diam ornare massa, ac vehicula leo turpis eget purus. Nunc
                                            pellentesque vestibulum mauris, eget suscipit
                                            mauris imperdiet vel. Nulla et massa metus. Nam porttitor quam eget ante
                                            elementum consectetur. Aenean ac nisl
                                            et nulla placerat suscipit eu a mauris. Curabitur quis augue condimentum,
                                            varius mi in, ultricies velit.
                                            Suspendisse potenti.
                                        </p>
                                        <a href="#" class="reply"><span class="fa fa-reply mr-2"></span>Reply</a>
                                        <hr>
                                    </div>
                                </li>
                                <li>
                                    <ul class="comments-child">
                                        <li class="comment">
                                            <div class="ts-circle__sm float-left mr-4">
                                                <div class="ts-img-into-bg">
                                                    <img src="assets/img/img__person--02.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="comment-wrapper">
                                                <div class="name">John Doe</div>
                                                <span class="date"><span
                                                        class="fa fa-calendar mr-2"></span>24.06.2014</span>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla
                                                    vestibulum, sem ut sollicitudin consectetur,
                                                    augue diam ornare massa, ac vehicula leo turpis eget purus. Nunc
                                                    pellentesque vestibulum mauris, eget suscipit
                                                    mauris.
                                                </p>
                                                <a href="#" class="reply"><span
                                                        class="fa fa-reply mr-2"></span>Reply</a>
                                                <hr>
                                            </div>
                                        </li>
                                    </ul>
                                ...
                                <li class="comment">
                                    <div class="ts-circle__sm float-left mr-4">
                                        <div class="ts-img-into-bg">
                                            <img src="assets/img/img__person--03.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="comment-wrapper">
                                        <div class="name">John Doe</div>
                                        <span class="date"><span class="fa fa-calendar mr-2"></span>08.05.2014</span>
                                        <p>Quisque iaculis neque at dui cursus posuere. Sed tristique pharetra orci, eu
                                            malesuada ante tempus nec.
                                            Phasellus enim odio, facilisis et ante vel, tempor congue sapien. Praesent
                                            eget ligula
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="form-blog-reply-name"
                                                   name="form-blog-reply-name" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="form-blog-reply-email">Your Email<em>*</em></label>
                                            <input type="email" class="form-control" id="form-blog-reply-email"
                                                   name="form-blog-reply-email" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="form-blog-reply-message" rows="5"
                                                      name="form-blog-reply-message" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group clearfix">
                                    <button type="submit" class="btn btn-primary" id="form-blog-reply-submit">Leave a
                                        Reply
                                    </button>
                                </div>
