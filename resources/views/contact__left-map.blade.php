    ...
    <div id="main-navigation">
        <nav class="navbar navbar-dark">
            <ul class="navbar-nav">
                ...
                -->
                <li class="nav-item">
                    <a class="nav-link active" href="#collapse__contact" data-toggle="collapse"
        ...
        <main id="ts-content">
            ...
            <div class="container-fluid px-0">
                <div class="row">
                    ...
                    -->
                    <div class="col-md-6 ">
                        <section class="map h-100 w-100" id="map-contact"></section>
                    </div>
                    ...
                    <div class="col-md-6">
                        <section class="p-3 p-sm-5">
                            ...
                            <header class="mb-5">
                                <div class="ts-title">
                                    <h1 class="ts-text-underline">Let’s Talk Together</h1>
                                </div>

                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque nec nunc vitae
                                    nibh
                                    congue pellentesque. Mauris scelerisque quam semper feugiat tincidunt. Pellentesque
                                    a
                                    ullamcorper erat, id dapibus velit. Aliquam erat volutpat. Proin at sapien leo.
                                    Nullam
                                    fermentum purus ac massa dignissim, in cursus turpis lobortis. Aliquam lacinia ante
                                    a velit
                                    viverra scelerisque. Suspendisse nec dui sed tortor mollis rutrum nec at leo.
                                </p>
                            </header>
