...
<div class="ts-page-wrapper">
    ...
    <div class="ts-content">
        ...
        ================================================================================================================
        -->
        <header id="ts-hero" class="ts-height--100vh text-white ts-has-overlay align-items-end">

            <div class="container pb-5">
                <h1>StarCreative</h1>
                <h4>Graphic Design, UX/UI, Developing</h4>
            </div>

            <div class="ts-background owl-carousel ts-slider" data-owl-loop="1" data-owl-items="1">
                <div class="ts-slide">
                    <div class="ts-img-into-bg ts-background-image">
                        <img src="assets/img/img__work__bg--01.jpg" alt="">
                    </div>
                </div>
                <div class="ts-slide">
                    <div class="ts-img-into-bg ts-background-image">
                        <img src="assets/img/img__work__bg--02.jpg" alt="">
                    </div>
                </div>
                <div class="ts-slide">
                    <div class="ts-img-into-bg ts-background-image">
                        <img src="assets/img/img__work__bg--03.jpg" alt="">
                    </div>
                </div>
            </div>
        ...
        <main id="ts-content">
            ...
            ============================================================================================================
            -->
            <section id="brief" class="ts-block">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque nec
                                nunc vitae
            ...
            ============================================================================================================
            -->
            <section id="blockquote" class="ts-block ts-background-repeat text-center"
                        ...
                        <div class="col-md-9 offset-sm-1">
                            <blockquote class="blockquote">
                                <h4 class="font-weight-light">
                                    Cras nisl lacus, tincidunt vitae neque vitae, interdum iaculis
            ...
            <section class="ts-block">
                <div class="container">
                    <img src="assets/img/img__work__bg--01.jpg" alt="" class="img-fluid">
                </div>
            </section>
            ...
            ============================================================================================================
            -->
            <section id="gallery" class="ts-block pt-5">
                <div class="container">

                    <div class="row ts-gallery">

                        <div class="col-md-6">
                            <a href="portfolio__detail--default.html" class="card ts-gallery__item">
                                <div class="ts-background ts-img-into-bg">
                                    <img src="assets/img/img__work--01.jpg" alt="">
                                </div>
                            </a>
                        </div>
                        <!--end gallery item-->
                        ...
                        <div class="col-md-6">
                            <a href="portfolio__detail--default.html" class="card ts-gallery__item">
                                <div class="ts-background ts-img-into-bg">
                                    <img src="assets/img/img__work--02.jpg" alt="">
                                </div>
                            </a>
                        </div>
                        <!--end gallery item-->
                        ...
                        <div class="col-md-4">
                            <a href="portfolio__detail--default.html" class="card ts-gallery__item ts-half">
                                <div class="ts-background ts-img-into-bg">
