...
<div class="ts-page-wrapper">
    ...
    <div id="main-navigation">
        <nav class="navbar navbar-dark" data-bg-color="#0f1018">
            <ul class="navbar-nav">
    ...
    <div class="ts-content">
        ...
        <header id="ts-hero" class="ts-height--100vh text-white">
                ...
                <div class="row ts-align__vertical">
                    ...
                    <div class="col-sm-6 col-md-7">
                        ...
                        <div data-animate="ts-fadeInUp" data-ts-delay=".1s">
                            <p>
                                Aenean et feugiat libero. Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                In suscipit fringilla dolor. Fusce volutpat nulla sed placerat tempor
                            </p>
                        </div>

                        <div class="ts-group d-none d-md-block">
                            <a href="#" class="btn btn-light mr-2 my-2" data-animate="ts-fadeInUp" data-ts-delay=".15s">Buy
                                Now</a>
                            <a href="#" class="btn btn-outline-light my-2" data-animate="ts-fadeInUp"
                               data-ts-delay=".2s">Read More</a>
                        </div>
                    </div>

                    <div class="col-sm-6 col-md-5">
                        <div class="text-center d-none d-sm-block" data-animate="ts-fadeInRight" data-ts-delay=".25s">
                            <img src="assets/img/img__mobile--01.png" class="ts-img-fluid py-5" alt="">
                        </div>
                    </div>
            ...
            <div class="ts-background ts-bg-black">
                <div class="ts-img-into-bg ts-background-image ts-parallax-element">
                    <img src="assets/img/bg__gradient--dark.jpg" alt="">
                </div>
            </div>
        ...
        <main id="ts-content">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-5">
                            <img src="assets/img/img__mobile--02.png" class="mw-100" alt="">
                        </div>
            ...
            ============================================================================================================
            -->
            <section id="achieved" class="ts-block text-center text-white pb-0" data-bg-color="#1e1e27">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-sm-2">
                            <p class="mb-5 pb-3">
                                ...
                                tristique
                                finibus lorem. Nullam sed eleifend massa. Morbi nulla turpis, pharetra et nisl eu,
                                pellentesque
                                molestie erat
                            </p>
                        </div>
                    ...
                    <div>
                        <img src="assets/img/img__dashboard.png" class="img-fluid" alt="">
                    </div>
            ...
            <section id="blockquote" class="ts-block">
                <div class="container">
                    ...
                    <blockquote class="blockquote mb-5">
                        <h2>Cras nisl lacus, tincidunt vitae neque vitae, interdum iaculis tortor. Orci varius
                            natoque</h2>
                        <footer class="blockquote-footer">Penatibus et magnis dis parturient montes nascetur</footer>
                    </blockquote>

                    <a href="#" class="ts-link ts-underline mb-5 m-sm-0 d-inline-block">More About Us</a>
        ...
        ================================================================================================================
        -->
        <footer id="ts-footer" data-bg-color="#060714">
