        ...
        <header id="ts-hero" class="ts-height--100vh text-white">
            ...
            <div class="owl-carousel ts-slider" data-owl-dots="1" data-owl-loop="1" data-owl-items="1">
                ...
                <div class="ts-slide ts-has-overlay">
                    <div class="container">
                        <h1>
                            <a href="#" class="ts-underline">Eatery Mobile App</a>
                        </h1>
                ...
                <div class="ts-slide ts-has-overlay">
                    <div class="container">
                        <h1>
                            <a href="#" class="ts-underline">Pandorff Redesign</a>
                        </h1>
                ...
                <div class="ts-slide ts-has-overlay">
                    <div class="container">
                        <h1>
                            <a href="#" class="ts-underline">RidiCool Band Album</a>
                        </h1>
                    ...
                    <div class="ts-background">
                        <div class="ts-img-into-bg ts-background-image ts-parallax-element">
                            <img src="assets/img/img__work__bg--04.jpg" alt="">
                        </div>
                    </div>
                </div>
                <!--end Slide-->
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <a href="contact__default.html" class="ts-underline ts-link">Contact Us</a>
                        </div>
                        <!--end Paragraph-->
